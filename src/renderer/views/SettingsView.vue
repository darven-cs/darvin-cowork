  ...
  <div class="flex min-w-0 flex-col h-full">
    ...
    <div class="flex-1 flex items-center justify-center px-6">
      <div class="text-center">
        <Icon name="cog" :size="36" class="mx-auto mb-3 text-text-muted" />
        <h2 class="font-display text-xl font-medium text-text">设置</h2>
        <p class="mt-1 font-sans text-sm text-text-muted">PR-4 实现</p>
      </div>
    </div>
  </div>
</template>

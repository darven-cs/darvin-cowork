<template>
  <div class="px-6 pb-5 pt-2">
    <div
      class="mx-auto flex max-w-[720px] items-end gap-2 rounded-2xl border border-border bg-surface-2 px-4 py-3 transition-colors focus-within:border-border-strong"
    >
      <textarea
        ref="textareaRef"
        v-model="text"
